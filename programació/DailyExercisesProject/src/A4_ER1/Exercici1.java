...
//        }
    ...
    private static String[] letterComb(String letter1, String letter2, String letter3) {
    ...
    private static String letterCombRecursive(String[] letters, int i, int j, int k, String combination) {
        if (i== 2 && j == 2 && k == 2) {
